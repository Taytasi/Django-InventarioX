"""
Django settings for INVENTARIOX project.
...
SECRET_KEY = 'django-insecure-mb^x))%guk6qwg-p=x+1h38)k62zo#s%g603i$6#(b00j#=uju'
...
WSGI_APPLICATION = 'INVENTARIOX.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'MyNewPass1', # Cambia por tu contraseña
